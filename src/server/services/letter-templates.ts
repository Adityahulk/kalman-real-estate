...
<p class="agreement-detail-heading reference-page-break"><u><strong>DETAILS OF PRICING:</strong></u></p>
...
<p class="pricing-words"><strong>(Rupees {{plot.priceInrWords}} Only)</strong></p>
<p class="agreement-detail-heading"><strong>DETAILS OF PAYMENTS RECEIVED:</strong></p>
<table class="payments">
<tr><th>Cheque No./<br>RTGS/NEFT</th><th>Date of Cheque</th><th>Amount</th><th>Drawn on Bank</th></tr>
</table>
<p class="agreement-payment-copy">The allottee / vendee shall pay to the promoters / colonizers on prorata basis, the price of said plot, if the dimensions of the said plot increase.</p>
<p class="agreement-payment-copy">The colonizers /promoters promise to adjust on prorate basis, the price of plot, if the dimensions of the said plot and hence the area decreases.</p>
<p class="agreement-payment-copy">In addition to the Total Price as mentioned above, the Allottee will be liable and agrees to pay club house which will be built by the firm, the firm have right to charge maintenance and the firm also reserve right to demand membership fee, these charges will be decided by the firm from time to time.</p>
...
<p class="clause-block reference-page-break"><span class="clause-heading"><span class="clause-heading-number"><strong>6.</strong></span><span class="clause-heading-text"><strong>ESSENCE OF THE AGREEMENT</strong></span></span><span class="clause-body">The payment on or before the due date, of Total Price and other amounts payable as per the payment plan, as accepted by the Allottee or as demanded by the Firm from time to time is the essence of this Agreement.</span></p>
</section>
