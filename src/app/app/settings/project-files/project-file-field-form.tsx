...
export function ProjectFileFieldForm({ section = "PROJECT_FILES", parentId }: { section?: "PROJECT_FILES" | "PROJECT_MAPS" | "PROJECT_DETAILS"; parentId?: string }) {
  ...
  const fieldType = parentId ? "sub-option" : section === "PROJECT_MAPS" ? "project map" : section === "PROJECT_DETAILS" ? "project detail field" : "project file";
